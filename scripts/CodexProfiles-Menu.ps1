...
list = list profiles
status / doctor / verify / processes / repair / sync-check / diagnostics / pool / route = tools
...
switch -Regex ($choice) {
    ...
    '^(?i)status|verify|doctor|processes|repair|sync-check|diagnostics|pool|route$' {
